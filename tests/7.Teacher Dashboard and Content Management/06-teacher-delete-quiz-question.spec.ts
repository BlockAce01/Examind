...
test.describe('Teacher Dashboard and Content Management', () => {
  test('7.6 Teacher - Delete Quiz Question', async ({ page }) => {
    ...
    if (await editButton.count() > 0) {
      ...
      const deleteQuestionButton = page.getByRole('button', { name: /Delete/i }).first();
      if (await deleteQuestionButton.count() > 0) {
