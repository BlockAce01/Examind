...
test.describe('Admin Dashboard and User Management', () => {
  test('8.8 Admin - Manage Resources', async ({ page }) => {
    ...
    // Expected Results: Admin can see all resources from all users
    const resourceList = page.locator('[data-testid="admin-resource-list"]');
