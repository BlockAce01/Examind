...
// Make sure 'error' (lowercase) is destructured here
const Input: React.FC<InputProps> = ({ label, id, error, ...props }) => {
  return (
    <div className="mb-3">
      ...
      <input
        id={id}
        // Check that 'error' (lowercase) is used in the className logic
        ...
        // Check that 'error' (lowercase) is used in the aria attributes logic
        aria-invalid={!!error}
