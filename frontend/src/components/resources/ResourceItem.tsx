...
import { DocumentTextIcon, VideoCameraIcon, ClipboardDocumentListIcon, CalendarDaysIcon, TagIcon, IdentificationIcon } from '@heroicons/react/24/outline';
import { type Resource } from '@/types/resource'; 
interface ResourceItemProps {
  resource: Resource; 
}
// Help function to get an icon based  resource type
            ...
            <div className="flex-grow">
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-gray-500">
                    <span className="flex items-center bg-gray-100 px-2 py-0.5 rounded">
                        <IdentificationIcon className="w-3 h-3 mr-1"/> {resource.Type} {/*  correct casing */}
                    </span>
                    <span className="flex items-center bg-gray-100 px-2 py-0.5 rounded">
                        <TagIcon className="w-3 h-3 mr-1"/> {resource.Subject} {/*  correct casing */}
                    </span>
                    {/*  correct casing */}
                    {resource.Year && (
                        <span className="flex items-center bg-gray-100 px-2 py-0.5 rounded">
